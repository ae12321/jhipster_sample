...
import com.mycompany.myapp.web.rest.body.JacksonSample;
...
@RequestMapping("/api")
@Transactional
public class JacksonSapmeResource {

    private final Logger log = LoggerFactory.getLogger(JacksonSapmeResource.class);
    ...
    public JacksonSapmeResource(CarRepository carRepository) {
        this.carRepository = carRepository;
    }

    // https://b1san-blog.com/post/spring/spring-jackson/

    @PostMapping("/jackson1")
    public ResponseEntity<JacksonSample> post1(@RequestBody JacksonSample jacksonSample) {
        System.out.println(jacksonSample.getAuthor());
